...
- **Guess the Song** – the host plays the first seconds of a song (YouTube intro from fixed video IDs, the next song is buffered while the result is shown; iTunes preview as fallback), everyone types artist and title on their phone (no suggestions for the artist; once the artist is right, the title field suggests that artist's songs; small typos are fine; unlimited tries for the artist, 3 for the title), fastest right answer scores most. First 10 s of the intro, then 30 s to guess; if nobody has the title, the song plays again until the 2 minutes are up; after the first right title everyone gets 10 more seconds. Categories: 2000s, 2010s, Current hits, K-Pop, Disney (German), Anime (German), Anime (Japanese) (198 songs).

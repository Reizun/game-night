...
- **Color Toon** – a cartoon, game or anime character with one part hatched (Pikachu's cheeks, Mario's overalls, Luffy's hat …); color it in from memory (29 characters, 53 colors, everyday objects optional).

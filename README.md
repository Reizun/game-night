...
- **Color Toon** – a cartoon, game or anime character with one part hatched (Pikachu's cheeks, Mario's overalls, Luffy's straw hat …); color it in from memory. 40 official pictures loaded from Wikipedia at runtime (not stored in this repo; region masks by flood fill, shading kept) plus 13 drawings; everyday objects optional.
